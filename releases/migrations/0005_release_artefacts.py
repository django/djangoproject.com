...
def default_tarball():
    V = models.Value
    F = models.F
    T = partial(Cast, output_field=models.CharField())

    # releases/{major}.{minor}/Django-{version}.tar.gz
    return Concat(V("releases/"), T("major"), V("."), T("minor"), V("/Django-"), F("version"), V(".tar.gz"))
...
def default_wheel():
    ...
    return Concat(V("releases/"), T("major"), V("."), T("minor"), V("/Django-"), F("version"), V("-py3-none-any.whl"))
...
def default_checksum():
    ...
    return Concat(V("pgp/Django-"), F("version"), V(".checksum.txt"))


def populate_artefacts(apps, schema_editor):
    """
    ...
    Release.objects.update(
        ...
        wheel=Case(
            *(When(version=k, then=models.Value(v)) for k, v in VERSION_TO_WHEEL.items()),
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='release',
            name='wheel',
            field=models.FileField(blank=True, upload_to=releases.models.upload_to_wheel),
        ),
        migrations.AddField(
            model_name='release',
            name='checksum',
        ...
        migrations.RunPython(populate_artefacts, migrations.RunPython.noop),
    ]
