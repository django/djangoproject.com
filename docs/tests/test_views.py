...
class SearchFormTestCase(TestCase):
    ...
    def test_code_links(self):
        ...
        for query, expected_code_links in [
            (
                "queryset",
                f'<div class="code-links"><a href="{base_url}#django.db.models.query.'
                'QuerySet"><div><code>QuerySet</code><div class="meta">django.db.'
                "models.query</div></div></a></div>",
            ),
            (
                "select",
                f'<div class="code-links"><a href="{base_url}#django.db.models.query.'
                'QuerySet.select_for_update"><div><code>QuerySet.select_for_update'
                '</code><div class="meta">django.db.models.query</div></div></a><a '
                f'href="{base_url}#django.db.models.query.QuerySet.select_related">'
                '<div><code>QuerySet.select_related</code><div class="meta">django.db.'
                "models.query</div></div></a></div>",
            ),
        ]:
