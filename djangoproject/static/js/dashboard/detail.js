define('dashboard/detail', ['jquery', 'jquery.flot', 'dashboard/dddash'], function ($, plot, dddash) {
    $(function () {
        var e = $("#graph");
        ...
        $.getJSON(url, function (response) {
            ...
            var format_message = function (timestamp, measurement) {
                ...
                return dddash.formatTimestamp(timestamp, response.period) + '<br>' + measurement + ' ' + unit;
            };
