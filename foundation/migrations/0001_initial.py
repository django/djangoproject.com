    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "business_type",
                    models.CharField(
                        choices=[("new", "New"), ("ongoing", "Ongoing")], max_length=25
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="meetings_attended", to="foundation.BoardMember"
                    ),
                ),
                (
                    "leader",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                to="foundation.NonBoardAttendee",
            ),
        ),
        migrations.AddField(
            model_name="business",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="individual_members_approved",
                to="foundation.Meeting",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="corporate_members_approved",
                to="foundation.Meeting",
            ),
        ),
        migrations.AddField(
